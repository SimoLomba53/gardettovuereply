  ...
  <body>
    ...
    <main>
      <div class="parallax-container4">
        <div class="parallax4" :style="parallaxStyle"></div>
        <div class="contenti4 col-12">
          <div class="col-12 allonfourwallpaper d-flex align-items-center">
            <div class="col-8 d-flex flex-column justify-content-center p-4">
              <h1 class="text-white fadein visible">ALL ON FOUR</h1>
              <router-link class="text-dark" :to="{ name: 'Contact' }">
      ...
      <section>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              ...
              <h1 class="h1blue">IMPIANTO ALL-ON-FOUR</h1>
              <p>In caso di pazienti completamente edentuli, possiamo valutare la soluzione dell’impianto all-on-four, una
                tecnica all’avanguardia in cui siamo specializzati e che adottiamo costantemente con risultati eccellenti.
                Il metodo all-on-four sfrutta gli impianti posteriori come supporto protesico dalla tenuta ottimale, anche
                se hai un volume osseo molto ridotto.</p>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/allonfour1.jpg" alt="">
            </div>
          </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration bg-light">
          <div
            class="col-10 offset-1 col-sm-10 offset-sm-1 col-md-10 offset-md-1 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 d-flex flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row  ">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/inpocheoreallonfour.jpg" alt="">
            </div>
            <div
              ...
              <p>La protesi dell’intera arcata poggia su quattro impianti, si tratta perciò di una soluzione minimamente
                invasiva che riduce il numero di sedute necessarie all’installazione e ci permette di restituirti il
                sorriso anche se sei del tutto privo di denti in poche ore, grazie all’uso combinato della chirurgia
                guidata.</p>
            </div>
          </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center mb-5 mb-sm-5 mb-md-0 mb-lg-0 mb-xl-0 p-1 p-sm-1 p-md-5 p-lg-5 p-xl-5">
              <h1 class="h1blue">MATERIALI BIOCOMPATIBILI</h1>
              <p>Nel nostro studio, inoltre, utilizziamo materiali biocompatibili che rilasciano ioni di calcio e
                favoriscono un processo di osteointegrazione e di guarigione più veloce.</p>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/allonfour3.jpg" alt="">
            </div>
          </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration bg-light">
          <div
            class="col-10 offset-1 col-sm-10 offset-sm-1 col-md-10 offset-md-1 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 d-flex flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/allonfour4.jpg" alt="">
            </div>
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center mb-5 mb-sm-5 mb-md-0 mb-lg-0 mb-xl-0 p-1 p-sm-1 p-md-5 p-lg-5 p-xl-5">
              <h1 class="h1blue">ALL-ON-SIX</h1>
              <p>In casi particolari, è possibile eseguire un impianto all-on-six, poggiando cioè la protesi dell’arcata
                su sei impianti singoli anziché su quattro. Per sapere se questa metodologia fa al caso tuo, contattaci.
              </p>
            </div>
          </div>
        </div>
...
.parallax4 {
  ...
  bottom: 0;
  left: 0;
  background-image: url(/pexels-cedric-fauntleroy-4269687.jpg);
