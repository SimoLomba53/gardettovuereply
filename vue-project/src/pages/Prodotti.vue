        ...
        <main>
                ...
                <div class="contenti25 col-12">
                    <div class="col-12 backwallpaper d-flex align-items-center">
                        <div class="col-8 d-flex flex-column justify-content-center p-4">
                            ...
                            <p class="text-white fadein visible homepageparagraph">Il nostro studio dentistico, formato da
                                un team di
                                professionisti appassionati, offre una vasta gamma di servizi di alta qualità per tutta la
                                famiglia.</p>
                            <router-link class="text-dark" :to="{ name: 'Contact' }">
            ...
            <div class="col-12 intro">
                <div data-aos="fade-up" data-aos-duration="1000"
                    ...
                    <p class="fadein visible"><b>Esperienza ventennale</b>, aggiornamento costante e rigore professionale:
                        questo è
                        lo <b>Studio Dentistico Gardetto SRL</b> a San Benigno Canavese (a pochi km da Torino).</p>
                    <p><b>Professionisti</b> che uniscono diverse competenze e saperi, votati alla bellezza e alla salute
                        del vostro
                        sorriso, <b>quattro ambulatori</b> attrezzati con strumentazioni specifiche per ogni particolare
                        trattamento,
                        le più <b>moderne tecnologie</b> in campo odontoiatrico per operare con assoluta precisione ed
                        efficacia, la
                        più totale igiene e sterilità degli ambienti e degli strumenti, l’<b>alta competenza</b>
                        nell’offerta dei
                        migliori servizi per la salute orale dei nostri pazienti.</p>
                    <p>Lo Studio Dentistico Gardetto è tutto questo, garantendo sempre la massima cortesia e discrezione nel
                        miglior
                        comfort possibile per il paziente.</p>
                </div>
            </div>
            <hr>
                ...
                <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
                    <div
                        ...
                        <div
                            ...
                            <h3 class="">Gli impianti dentali sono la migliore opzione disponibile per sostituire i denti
                                mancanti o
                                danneggiati.</h3>
                            <p>Possono aiutarti a riacquistare la capacità di masticare. Perché lasciarsi sfuggire
                                l'opportunità?</p>
                            <router-link class="text-dark" :to="{ name: 'Impiantologia' }">
                ...
                <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
                    <div
                        ...
                        <div
                            ...
                            <P>Grazie alla nuova Tecnologia Airflow®, all’interno del protocollo GBT (Guided Biofilm
                                Therapy),
                                assicuriamo un’igiene orale ancora più profonda e senza dolore.</P>
                            <router-link class="text-dark" :to="{ name: 'TrattamentiGengivali' }">
                                <button>SCOPRI DI PIU</button>
                            </router-link>
                ...
                <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
                    <div
                        ...
                        <div
                            ...
                            <p>Offriamo una serie di diversi servizi di odontoiatria estetica per correggere difetti minori
                                e darti un
                                sorriso radioso.</p>
                            <router-link class="text-dark" :to="{ name: 'OdontoiatriaEstetica' }">
                                <button>SCOPRI DI PIU</button>
        ...
        <footer>
            ...
            <div class="footlist d-flex flex-row flex-wrap justify-content-center gap-5  mb-5">
                ...
                <div>
                    <ul class="text-center">
                        <h4>CONTATTACI</h4>
                        <li><span class="azzurro"><i class="fa-solid fa-location-dot "></i></span><span>Via Trento, 7</span>
                        </li>
                        ...
                        <li><a href="https://www.facebook.com/p/Studio-Dentistico-Fulvio-Gardetto-100063832021571/">Social
                                Network</a>
                        </li>
                    </ul>
                </div>
