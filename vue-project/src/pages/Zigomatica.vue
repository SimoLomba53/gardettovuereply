...
<template>
  ...
  <body>
    ...
    <main>
      <div class="parallax-container12">
        <div class="parallax12" :style="parallaxStyle"></div>
        <div class="contenti12 col-12">
          <div class="col-12 zigomaticawallpaper d-flex align-items-center">
            <div class="col-8 d-flex flex-column justify-content-center p-4">
              <h1 class="text-white fadein visible">IMPLANTOLOGIA ZIGOMATICA</h1>
              <router-link class="text-dark" :to="{ name: 'Contact' }">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              ...
              <p>Soluzione per gravi atrofie mascellari, con gli impianti zigomatici si possono avere denti fissi anche in
                assenza di osso. Si tratta di una tecnica innovativa per la riabilitazione delle gravi atrofie mascellari
                dove gli impianti vengono direttamente ancorati nell’osso zigomatico particolarmente indicato per
                l’osteointegrazione.</p>
            </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration bg-light">
          <div
            ...
            <div
              ...
              <p>Tale procedura trova anche valida applicazione in tutti quei casi dove altre tecniche abbiano fallito.
                Questi interventi vengono eseguiti personalmente dal Dr Gardetto il quale oltre alla Specialità in
                Chirurgia Odontostomatologica ha conseguito un Master Universitario di II livello in tale disciplina</p>
            </div>
          </div>
        </div>
      </section>
      <div data-aos="fade-up" data-aos-duration="1000" class="col-12">
        <video controls loop class="col-8 offset-2">
          <source src="https://impiantizigomatici.it/wp-content/uploads/2020/10/Video-impianti-zigomatici-.mp4"
            type="video/mp4">
          <source src="https://impiantizigomatici.it/wp-content/uploads/2020/10/Video-impianti-zigomatici-.mp4"
            type="video/ogg">
        </video>
...
.parallax12 {
  ...
  bottom: 0;
  left: 0;
  background-image: url('/zigomaticawallpaper.jpg');
