...
<template>
  ...
  <body>
    ...
    <main>
      <div class="parallax-container6">
        <div class="parallax6" :style="parallaxStyle"></div>
        <div class="contenti6 col-12">
          <div class="col-12 gelwallpaper d-flex align-items-center">
            <div class="col-8 d-flex flex-column justify-content-center p-4">
              <h1 class="fadein visible">GEL PIASTRINICI</h1>
              <router-link class="text-dark" :to="{ name: 'Contact' }">
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              ...
              <h1 class="h1blue">PRGF</h1>
              <p>La tecnologia PRGF, basata sui gel piastrinici, è una delle soluzioni più all’avanguardia per la
                rigenerazione dei tessuti e viene applicata con successo in ambito odontoiatrico.</p>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/pgrf1.jpg" alt="">
            </div>
          </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration bg-light">
          <div
            ...
            <div
              ...
              <h1 class="h1blue">RIGENERAZIONE ACCELERATA</h1>
              <p>In caso di lesioni, il nostro corpo provvede spontaneamente a rilasciare proteine che stimolano la
                guarigione. Partendo da un campione del tuo sangue, la tecnologia PRGF permette di isolare e di trattare
                il plasma contenente le proteine necessarie ad accelerare la rigenerazione dei tuoi tessuti.</p>
            </div>
          </div>
        </div>
        <!--TERZA ILLUSTRAZIONE-->
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              ...
              <p>Il materiale così ottenuto, ricavato proprio da te, viene applicato sulla zona interessata e riesce a
                stimolare e velocizzare la guarigione post-intervento, riducendo la tua sensazione di dolore e garantendo
                una miglior presa ad esempio in caso di impianto dentale. Contattaci per conoscere nel dettaglio i nostri
                trattamenti professionali con gel piastrinici.</p>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
...
.parallax6 {
  ...
  bottom: 0;
  left: 0;
  background-image: url('/pexels-jill-burrow-6387859.jpg');
