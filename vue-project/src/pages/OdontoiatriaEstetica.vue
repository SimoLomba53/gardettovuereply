  ...
  <body>
    ...
    <main>
      <div class="parallax-container8">
        <div class="parallax8" :style="parallaxStyle"></div>
        <div class="content8 col-12">
          <div class="col-12 esteticawallpaper d-flex align-items-center">
            <div class="col-8 d-flex flex-column justify-content-center p-4">
              <h1 class="text-white fadein visible">ODONTOIATRIA ESTETICA</h1>
              <router-link class="text-dark" :to="{ name: 'Contact' }">
      ...
      <section>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              ...
              <p class="esteticap">Ricordi quando avevi un sorriso smagliante? Lo sbiancamento dei denti può aiutarti a
              ...
              <p class="esteticap"><span class="fw-bold esteticap">Sbiancamento combinato:</span> Per un risultato ancora
                ...
                dell'igenista dentale. Successivamente verrà consegnato il kit domiciliare con mascherine
                personalizzate,che utilizzerai per alcune settimane.</p>
              <p class="esteticap">Entrambe queste tipologie di sbiancamento hanno lunga durata, e possono essere ripetute
                nel tempo con costi ridotti.</p>
            </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration bg-light">
          <div
            ...
            <div
              ...
              <h1 class="h1blue">CORONE</h1>
              <p>Le corone dentali vengono utilizzate per ripristinare i denti che sono stati danneggiati da una grande
                carie o da una frattura minore. Una corona è come un cappellino che copre la parte superiore del dente per
                renderlo più forte ed evitare che si rompa. Può essere realizzato con una vasta gamma di materiali.</p>
            </div>
          </div>
        </div>
        <!--TERZA ILLUSTRAZIONE-->
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration bg-light">
          <div
            class="col-10 offset-1 col-sm-10 offset-sm-1 col-md-10 offset-md-1 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 d-flex flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/diastema2.jpg" alt="">
            </div>
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center mb-5 mb-sm-5 mb-md-0 mb-lg-0 mb-xl-0 p-1 p-sm-1 p-md-5 p-lg-5 p-xl-5">
              <h1 class="h1blue">CHIUSURA DEL DIASTEMA</h1>
              <p>Un diastema è un grande spazio tra due denti. A seconda della gravità del caso, il dentista può suggerire
                faccette o un trattamento ortodontico. Prima di consigliare una procedura, il tuo dentista valuterà sempre
                attentamente la natura del problema in modo da ottenere il trattamento giusto per le tue esigenze.</p>
            </div>
          </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="col-12 illustration">
          <div
            ...
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center mt-5 mt-sm-5 mt-md-0 mt-lg-0 mt-xl-0 p-1 p-sm-1 p-md-5 p-lg-5 p-xl-5">
              <h1 class="h1blue">INLAY E ONLAY</h1>
              <p>Gli inlay e gli onlay sono restauri dentali che rinforzano i denti gravemente danneggiati o cariati</p>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/inlay.jpg" alt="">
            </div>
          </div>
        </div>
        <!--SESTA ILLUSTRAZIONE-->
        <div class="col-12 illustration bg-light">
          <div data-aos="fade-up" data-aos-duration="1000"
            class="col-10 offset-1 col-sm-10 offset-sm-1 col-md-10 offset-md-1 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2 d-flex flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
              <img src="/diamond.jpg" alt="">
            </div>
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center mb-5 mb-sm-5 mb-md-0 mb-lg-0 mb-xl-0 p-1 p-sm-1 p-md-5 p-lg-5 p-xl-5">
        ...
        <div class="col-12 illustration">
          <div data-aos="fade-up" data-aos-duration="1000"
            ...
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-flex flex-column justify-content-center mt-5 mt-sm-5 mt-md-0 mt-lg-0 mt-xl-0 p-1 p-sm-1 p-md-5 p-lg-5 p-xl-5">
              <h1 class="h1blue">PONTI</h1>
              <p><span class="fw-bold">Ponti permanenti:</span> I ponti vengono utilizzati per sostituire i denti
                mancanti. Sono fissati ai denti adiacenti e possono aiutare a prevenire lo spostamento dei denti rimanenti
                e migliorare la capacità di masticazione. I ponti dentali sono trattamenti di lunga durata.</p>
              <p><span class="fw-bold">Ponti del Maryland:</span> Un ponte del Maryland è un dente di porcellana sostenuto
                da due piccole ali di metallo incollate ai denti adiacenti.</p>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
...
.parallax8 {
  ...
  bottom: 0;
  left: 0;
  background-image: url('/esteticawallpaper.jpg');
